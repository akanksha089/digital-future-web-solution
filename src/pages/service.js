                                        ...
                                        <div key={index} className="col-lg-3 col-md-6">
                                            <div className="service-item md-pb-30">
                                                ...
                                                <div className="service-thumb">
                                                    ...
                                                    <div className="transparent-shape"><img src={item.image} alt="shape" /></div>
                                                    ...
                                                    <Link href={`/service/${item.slug}`} className="service-btn">Read Details <i className="fa-regular fa-arrow-right"></i></Link>
                                                </div>
                                            </div>
                                        </div>
                                    ))
                    ...
                    <section className="service-cta">
                        ...
                        <div className="container">
                            <div className="service-cta-wrap">
                                ...
                                <a href="contact.html" className="rr-primary-btn cta-btn">
