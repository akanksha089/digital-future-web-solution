                        ...
                        data.blogs.map((item, index) => (
                            <div key={index} className="col-lg-3 col-md-6">
                                <div className="service-item md-pb-30 fade-top">
                                    <h4 className="service-text service-custom-text custom-heading"><a href={`/service/${item.slug}`}>/{item.title}</a></h4>
                                    <div className="service-thumb">
                                        ...
                                        <a href={`/service/${item.slug}`} className="service-btn">Read Details <i className="fa-regular fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        ))
